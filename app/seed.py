...
async def seed():
    ...
    async with async_session_factory() as session:
        ...
        users = [
            User(
                id="admin-1", email="admin@studybase.edu", name="Dr. Rajesh Kumar",
                hashed_password=password, role="admin", avatar="👨‍💼",
                department="Administration", phone="+91-9876543210", join_date="2020-01-15",
            ),
            User(
                id="teacher-1", email="teacher@studybase.edu", name="Prof. Priya Sharma",
            ...
            User(
                id="teacher-2", email="prof.amit@studybase.edu", name="Prof. Amit Kumar",
                hashed_password=password, role="teacher", avatar="👨‍🏫",
                department="Computer Science", phone="+91-9876543216", join_date="2020-03-20",
                specialization="Networks",
            ),
            User(
                id="student-1", email="student@studybase.edu", name="Arjun Patel",
